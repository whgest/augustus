...
static const building_type MENU_BUILDING_TYPE[BUILD_MENU_MAX][BUILD_MENU_ITEM_MAX] = {
    ...
    {BUILDING_MENU_AESTHETICS, BUILDING_GARDENS, BUILDING_PLAZA, BUILDING_ENGINEERS_POST, BUILDING_LOW_BRIDGE, BUILDING_SHIP_BRIDGE,
    ...
    {BUILDING_SMALL_POND, BUILDING_LARGE_POND, BUILDING_PAVILION_BLUE, BUILDING_PAVILION_RED, BUILDING_PAVILION_ORANGE, BUILDING_PAVILION_YELLOW, BUILDING_PINE_TREE, BUILDING_FIR_TREE,
        BUILDING_OAK_TREE, BUILDING_ELM_TREE, BUILDING_FIG_TREE, BUILDING_PLUM_TREE, BUILDING_PALM_TREE, BUILDING_DATE_TREE, 0}
};
...
static void enable_normal(int *enabled, building_type type)
{
    ...
    enable_if_allowed(enabled, type, BUILDING_MENU_AESTHETICS);
