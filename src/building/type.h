...
typedef enum {
    ...
    BUILDING_MENU_AESTHETICS = 116,
    BUILDING_SMALL_POND = 117,        
    BUILDING_LARGE_POND = 118,
    BUILDING_PINE_TREE = 119,
    BUILDING_FIR_TREE = 120,
    BUILDING_OAK_TREE = 121,
    BUILDING_ELM_TREE = 122,
    BUILDING_FIG_TREE = 123,
    BUILDING_PLUM_TREE = 124,
    BUILDING_PALM_TREE = 125,
    BUILDING_DATE_TREE = 126,
    BUILDING_PAVILION_BLUE = 127,
    BUILDING_PAVILION_RED = 128,
    BUILDING_PAVILION_ORANGE = 129,
    BUILDING_PAVILION_YELLOW = 130,
    // helper constants
    BUILDING_TYPE_MAX = 131
} building_type;
